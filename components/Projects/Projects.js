      ...
      <div className="flex flex-col py- justify-center h-full">
        ...
        >
          ...
          <h2 className="text-[1.65rem] font-medium md:max-w-lg max-w-sm mt-2 staggered-reveal">
            Em đã từng đi thực tập tại 1 công ty bảo hiểm và vì tính chất bảo
            mật của công ty nên em không thể show source code của dự án đó. Dưới
            đây là một số dự án mà em đã từng thực hiện khi còn trên ghế nhà
            trường
          </h2>
        </div>
        <div
