      ...
      >
        ...
        >
          <span className="about-1 leading-tight">
            Em là một Kỹ sư đam mê, tập trung vào việc xây dựng các ứng dụng có
            khả năng mở rộng và hiệu suất cao.{" "}
          </span>
          <span className="about-2 leading-tight">
            Em chịu trách nhiệm tạo ra trải nghiệm người dùng tốt bằng cách sử
            dụng kiến ​​trúc giao diện hiện đại.{" "}
          </span>
        </h1>
      </div>
    </section>
